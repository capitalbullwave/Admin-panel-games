  ...
  const data = [
    {
        ...
        "Description": "Platform name, logo, timezone",
        "Last Updated": "1 Month ago",
        "Status": "Active"
    },
    {
        "Setting Category": "Referral Program",
        "Description": "Commission rates and levels",
        "Last Updated": "2 Weeks ago",
        "Status": "Active"
    },
    {
        "Setting Category": "Maintenance",
        "Description": "System downtime toggle",
    ...
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-sm text-slate-400 mt-1">Configure global platform settings and parameters.</p>
        </div>
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm text-left">
              <thead className="text-xs text-slate-400 uppercase bg-black/20 border-b border-white/5">
                <tr>
                  <th className="px-6 py-4 font-semibold">Setting Category</th>
