...
template = """import { Card, CardContent, CardHeader, CardTitle } from "@/components/ui/card";
      ...
      <Card className="border-white/10 bg-white/5 backdrop-blur-md shadow-xl overflow-hidden">
        ...
        <CardContent className="p-0">
          ...
          <div className="flex items-center justify-between px-6 py-4 border-t border-white/5 bg-black/10">
            <span className="text-sm text-slate-400">Showing 1 to {len_data} of {len_data} entries</span>
...
def generate():
    ...
    for route, config in pages.items():
        ...
        content = template.format(
            ...
            row_renders=row_renders_str,
            len_data=len(config["data"])
        )
