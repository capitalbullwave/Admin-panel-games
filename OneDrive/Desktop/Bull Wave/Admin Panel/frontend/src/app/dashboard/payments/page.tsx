  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h2 className="text-3xl font-extrabold tracking-tight text-white">Payment Management</h2>
          <p className="text-sm text-slate-400 mt-1">Manage payment gateways and manual adjustments.</p>
        </div>
