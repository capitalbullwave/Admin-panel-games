  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h2 className="text-3xl font-extrabold tracking-tight text-white">Reports & Analytics</h2>
          <p className="text-sm text-slate-400 mt-1">View detailed platform analytics and financial reports.</p>
        </div>
              ...
              <tbody className="divide-y divide-white/5">
                {filteredData.map((row, i) => (
                  <tr key={i} className="hover:bg-white/5 transition-colors group">
                    <td className="px-6 py-4 font-medium text-white group-hover:text-amber-400 transition-colors">{row["Report Name"]}</td>\n                    <td className="px-6 py-4 text-slate-300">{row["Generated By"]}</td>\n                    <td className="px-6 py-4 text-slate-300">{row["Format"]}</td>\n                    <td className="px-6 py-4 text-slate-300">{row["Size"]}</td>\n                    <td className="px-6 py-4 text-slate-300">{row["Date"]}</td>
